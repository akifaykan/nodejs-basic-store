...
const isAuthenticated = require("../middleware/middleware-authentication");
...
router.get('/categories', locals, shopController.getCategories)
router.get('/category/:categoryid', locals, shopController.getProductsByCategoryId)
